...
width=720
length=65
CUDA_VISIBLE_DEVICES=0 python experiments/ablation.py --exp_name 720p --compress_denoise_steps 1 --flow-reverse --keep_token_ratio 0.7 --video-size ${height} ${width} --video-length ${length}