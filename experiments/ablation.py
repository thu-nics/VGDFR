...
for prompt in all_prompts:
    ...
    for before_compression_steps in [int(args.infer_steps * 0.1)]:
        ...
        if "LOCAL_RANK" not in os.environ or int(os.environ["LOCAL_RANK"]) == 0:
            for i, sample in enumerate(samples):
                ...
                save_folder = f"{save_path}/vgdfr_{args.exp_name}/cr_{args.keep_token_ratio}_k{before_compression_steps}"
